require 'nokogiri'
require 'open-uri'
class M4ufreeController < ApplicationController
	def index 
	...
	def page_urls
		...
		for i in 1..total_pages
			url_array << site_url + '/?sort=key_top&page='+i.to_s+'/'
		end 
		return url_array
	end 
	...
	def get_movie_information_from_a_div(movie_div) #that function will return hash of a single movies data
        ...
        movie_data[:movie_url]       = 'http://m4ufree.com/'+movie_div.css('a')[0]['href'].split('./')[1]
